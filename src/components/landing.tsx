    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto grid max-w-6xl gap-10 px-6 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:py-24">
        <section>
          ...
          <h1 className="mt-4 max-w-xl font-serif text-4xl leading-[1.15] tracking-tight text-ink md:text-5xl">
            {t("landing.title")}
          </h1>
          ...
          <ul className="mt-8 space-y-3 text-sm text-ink">
            {[t("landing.point1"), t("landing.point2"), t("landing.point3")].map((point) => (
              <li key={point} className="flex gap-3 rounded-xl bg-paper-raised/70 px-3.5 py-2.5 ring-1 ring-line/80">
        ...
        <aside className="paper-card h-fit p-7">
          <h2 className="font-serif text-2xl tracking-tight">{t("brand.name")}</h2>
